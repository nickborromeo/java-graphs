...
public class GraphTraversalTest {
	...
	public static void main(String[] args)  throws IOException {
		...
		GraphTraversal theGraph = new GraphTraversal(number);
	...
	static void displayVertices(GraphTraversal theGraph){
	...
	static void displayEdges(GraphTraversal theGraph){
